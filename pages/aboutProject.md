...
<div class="gallery-grid">
  <a href="{{ '/assets/images/mariasunset.JPG' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/mariasunset.JPG' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/tia.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/tia.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/mountains.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/mountains.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/tag.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/tag.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/white.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/white.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/pose.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/pose.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
  <a href="{{ '/assets/images/coldplay.jpeg' | relative_url }}" class="glightbox" data-gallery="project-gallery">
    <img src="{{ '/assets/images/coldplay.jpeg' | relative_url }}" alt="Photo 2" style="width: 100%; max-width: 300px;">
  </a>
